...
urlpatterns = [
    ...
    path(
        "fieldOfStudy/<int:pk>/",
        FieldOfStudyDetailView.as_view(),
        name="FieldOfStudy-detail",
    ),
    path(
        "fieldOfStudy/create/",
        FieldOfStudyCreateView.as_view(),
        name="FieldOfStudy-create",
    ),
    path(
        "fieldOfStudy/update/<int:pk>/",
        FieldOfStudyUpdateView.as_view(),
        name="FieldOfStudy-update",
    ),
    path(
        "fieldOfStudy/delete/<int:pk>/",
        FieldOfStudyDeleteView.as_view(),
        name="FieldOfStudy-delete",
    ),
]
